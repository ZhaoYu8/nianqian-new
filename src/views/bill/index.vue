...
export default {
  data() {
    return {
      arr: [
        { label: "客户名称", model: "", placeholder: "", span: 5, type: "page", data: [], id: "customer_id" },
      ...
      tableHeader: [
        ...
        { label: "完成数量", id: "schedule_sum", align: "right" },
  ...
  methods: {
    async queryTabel() {
      let res = await this.$post("bills/list", this.listQuery);
